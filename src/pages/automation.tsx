...
const Automation = () => {
  ...
  const sendConfig = async() => {
    ...
    const res = await axios.post(`${process.env.REACT_APP_BACKEND_API}/automation/run`, automationConfig)
  ...
  return (
    <>
      <div className="grid grid-rows-2 space-y-4">
        <div className="grid grid-cols-2 space-x-4">
          <MediumCard>
            ...
            <div className="grid grid-cols-3">
              ...
              <select className="col-span-2 rounded-lg border border-dark-quaternary-label dark:border-dark-quaternary-label p-2 bg-transparent" onChange={handlePriority}>
            ...
            <div className="grid grid-cols-3">
              ...
              <select className="col-span-2 rounded-lg border border-dark-quaternary-label dark:border-dark-quaternary-label p-2 bg-transparent" onChange={handlePlatform} value={automationConfig.platform}>
          ...
          <MediumCard className="relative space-y-2 max-w-screen-md rounded-lg overflow-hidden shadow-lg p-4 bg-mac-light-card dark:bg-mac-dark-card text-primary-label dark:text-dark-primary-label">
            <div className="grid grid-cols-3 gap-2 justify-items-stretch">
              ...
              <div className="col-start-2 col-end-4 justify-self-center">
                <label className="m-auto uppercase self-end">use element class</label>
              </div>
              <div className="absolute block max-w-full bottom-0 right-4 left-0">
                <button className="m-2 p-2 bg-blue-500 rounded-lg w-full uppercase"
                    onClick={() => sendConfig()}
                >
                  Go
                </button>
        ...
        <div className="bg-mac-light-card dark:bg-mac-dark-card rounded-lg p-4 text-primary-label dark:text-dark-primary-label">
          <span className="block text-lg m-2">Terminal Output</span>
          <pre className="bg-mac-light dark:bg-mac-dark p-4 rounded-lg overflow-y-auto">
            <code>Terminal text here</code>
          </pre>
        </div>
      </div>
    </>
